(function () {
  ...
  globalThis.CONSENT_DISCLOSURE_ITEMS = [
    'Detected legal-document text from this page is sent to your chosen AI provider when you summarize (cloud providers only).',
    'Chrome on-device AI mode processes text locally on your device — no cloud API key required.',
    'Nothing is sent until you accept; results are kept only in a local cache on your device.',
    'Your API key is stored locally on this device and sent only to the active cloud provider.',
    'This is a summary, not legal advice. AI can misread complex legal language.',
  ];
