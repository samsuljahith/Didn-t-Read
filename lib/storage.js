...
async function isPrivacyAcknowledged() {
  const result = await chrome.storage.local.get(STORAGE_KEYS.privacyAcknowledged);
  return Boolean(result[STORAGE_KEYS.privacyAcknowledged]);
}

async function setPrivacyAcknowledged() {
